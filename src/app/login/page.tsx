    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-mesh-gradient px-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-md glass-card p-8 rounded-2xl relative z-10 card-3d animate-slide-up">
                ...
                <p className="text-slate-400 text-center mb-8">Enter your credentials to access your dashboard.</p>
                ...
                <div className="mt-6 text-center text-sm text-slate-500">
                    Don't have an account? <Link href="/register" className="text-indigo-400 hover:text-indigo-300 hover:underline transition-colors">Sign up</Link>
                </div>
            </div>
        </div>
    );
